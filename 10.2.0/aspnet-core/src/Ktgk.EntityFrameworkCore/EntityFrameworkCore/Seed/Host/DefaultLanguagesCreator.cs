...
namespace Ktgk.EntityFrameworkCore.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly KtgkDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = KtgkConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(KtgkDbContext context)
    {
        _context = context;
    }
