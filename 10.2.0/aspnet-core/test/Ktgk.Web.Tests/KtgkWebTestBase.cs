...
public abstract class KtgkWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static KtgkWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(KtgkWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<KtgkDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<KtgkDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<KtgkDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<KtgkDbContext, Task<T>> func)
    {
        T result;
